  ...
  return (
    <section className="relative h-[80vh] bg-gray-800 flex items-center justify-center">
      ...
      <div className="relative z-10 container mx-auto p-4">
        <div className="text-white max-w-3xl mx-auto text-center space-y-4 animate-in fade-in duration-300">
          <span className="inline-block px-4 py-1 text-sm font-lato font-semibold text-white bg-[#C67C4E] rounded-full">{article.category}</span>
